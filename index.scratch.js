...
{
    var styleRaw = await fs.readFile(path.join(__dirname, 'node_modules', 'highlight.js', 'styles', name + '.css'));
...
/**
 * @param {{ child: any[]; node: string; attr: { class: any; }; text: any; }} obj
 * @param {{}} styleData
 */
 ...
 * @param {any} styleName
 */
async function(hljsHTML, styleName)
{
